...
- `6002-delay-edge-fields.cpd`: keeps Zone 1 Sounder Group, I/O Group, and Fire Brigade outputs delayed for every Zone 1 trigger device, including the manual call point at address `04`; override behavior is covered separately by `6002-manual-callpoint-override-delay.cpd`.
